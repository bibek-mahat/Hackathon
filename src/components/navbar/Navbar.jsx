...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 mb-7">
      <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between p-4">
        {/* Logo and Hamburger - spaced apart on all screen sizes, full width on small */}
        <div className="flex justify-between w-full md:w-auto">
          {/* Logo */}
          <a href="#" className="flex items-center">
            <img src={Logo} className="h-16 w-24 mr-2" alt="Logo" />
          </a>
